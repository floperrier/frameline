 ...
 * no Shot has no control to hand the keyboard to and none is invented. Focus
 * goes to the document because on that screen there is nothing to put it on.
 */
...
<template>
  <div class="reading">
    ...
    <p v-if="at.shot > 0 || at.taken.length > 0" class="again">
